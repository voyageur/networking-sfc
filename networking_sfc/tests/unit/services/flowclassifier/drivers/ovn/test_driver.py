...
from networking_sfc.services.flowclassifier.drivers.ovn import driver
from networking_sfc.tests import base
from networking_sfc.tests.unit.db import test_flowclassifier_db


class OVNFlowClassifierDriverTestCase(
    ...
    def setUp(self):
        ...
        super(OVNFlowClassifierDriverTestCase, self).setUp(
            ext_mgr=None,
            plugin=None,
        ...
        self.driver = driver.OVNFlowClassifierDriver()
    ...
    def test_create_flow_classifier_precommit_no_logical_dst_port(self):
        with self.port(
            name='port1',
            device_owner='compute',
            device_id='test',
